...
if uploaded:
    ...
    if st.button("🚀 Run Pipeline", type="primary"):
        if not (serper_key and gemini_key and openai_key):
            st.error("Please fill in all 3 API keys in the sidebar.")
            st.stop()
        ...
        with st.spinner("Running pipeline — this takes ~15s per contact (Gemini grounding)..."):
